...
export default function Home() {
  return (
    <main className="flex min-h-screen flex-col items-center justify-between">
      ...
      {/* Partners Section - 真正无缝无限滚动+首次渐现动效 */}
        ...
        <div className="container px-4 md:px-6">
          ...
          <div className="overflow-x-hidden w-full relative">
            <div className="marquee gap-16">
              {[
                "meta", "openai", "google", "microsoft", "amazon", "bytedance",
                "meta", "openai", "google", "microsoft", "amazon", "bytedance"
              ].map((brand, i) => (
                <motion.img
                  key={brand + i}
                  ...
                  alt={brand}
                  className="h-8 w-auto grayscale hover:grayscale-0 transition-all duration-300 drop-shadow-md bg-white rounded-lg p-2 hover:scale-110"
                  style={{ minWidth: 64 }}
