...
export default function Home() {
  return (
    <main className="flex min-h-screen flex-col items-center justify-between">
      ...
      <section className="w-full min-h-[70vh] flex flex-col items-center justify-center relative overflow-hidden bg-gradient-to-b from-blue-50 via-white to-blue-100 pb-10">
        ...
        <div className="w-full flex justify-center pt-12 pb-8">
          <motion.img
            ...
            animate={{ opacity: 1, y: 0, scale: [0.96, 1.01, 0.98, 1] }}
      ...
      {/* Partners Section - 无限滚动 */}
      <section className="w-full py-10 bg-blue-50 border-t border-b border-blue-100 overflow-x-hidden">
        <div className="container px-4 md:px-6">
          <motion.h3
            initial={{ opacity: 0, y: 20 }}
            whileInView={{ opacity: 1, y: 0 }}
          ...
          <div className="relative w-full overflow-x-hidden">
            ...
            >
              {Array(2).fill([
                "openai","google","microsoft","amazon","meta","bytedance"
              ]).flat().map((brand, i) => (
                <motion.img
                  key={brand + i}
                  src={`https://cdn.jsdelivr.net/gh/simple-icons/simple-icons/icons/${brand}.svg`}
                  alt={brand}
                  className="h-10 w-auto grayscale hover:grayscale-0 transition-all duration-300 drop-shadow-md bg-white rounded-lg p-2 hover:scale-110"
